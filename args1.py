...
def argument_parser():
    ...
    parser.add_argument('--q_shots', help='Number of query samples per task', default=5  , type=int)

    parser.add_argument('--s_shots', help='Number of support samples per task', default=5  , type=int)
    ...
    parser.add_argument('--block',  help='Block type for TimeHetNet',  default="gru,conv,conv,convSP,gru" , type=str)
    ...
    parser.add_argument('--num_epochs', help='Number of training epochs', default=50   , type=int)
    parser.add_argument('--control_groups', help='Number of control groups', default=[1, 2]  , type=int)
    parser.add_argument('--num_trials', help='Number of training epochs', default=100   , type=int)
    ...
    parser.add_argument('--patience'   , help='patience for early stopping', default=50   , type=int)
